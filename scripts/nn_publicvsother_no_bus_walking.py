...
This variant removes the words "bus" and "walking" from the text before
training and evaluation to assess their influence on model performance.
...
OUTPUT_DIR = (
    PROJECT_DIR
    / "model_outputs"
    / "nn_transportation_no_bus_walking"
)
...
# =============================================================================
# Prepare Text and Remove Target Words
# =============================================================================

REMOVE_WORDS = {"bus", "walking"}


def remove_words(text):
    """Remove specified whole words from the text."""
    if pd.isna(text):
        return ""
    text = str(text).lower()
    # Remove whole words only, preserving surrounding punctuation/spaces.
...
# Remove any rows where the text became empty after word removal.
