...
- **Owning this component means** that I authored the entirety of this component individ/11ually.
- **The commits or PRs that are most relevant are** [#11 - Add cleaning and EDA scripts](https://github.com/grantmooslin/DAGE/pull) where the component was added to the repo.
...
- **You can find this contribution in a files called** `nn_publicvsother.py` and 'nn_publicvsrideshare.py' within the `DAGE/scripts/nn_trans` directory.
